...
TODO:\todo{entweder mein Verfahren oder \cmd{pishrink} von @framp einbinden}
...
\uline{Inhalt von \filenam{/etc/asound.conf}:}\\
...
23.03.2018 TODO:\todo{Überprüfen, warum das zumindest mit dem omxplayer nicht funzt\dots}\\
Die von @smutbert bereitgestellte \filenam{/etc/asound.conf} funktioniert mit 
Raspbian Stretch 2018-03-13 beim omxplayer nicht: Mediadatei bleibt sofort bei 
0:00 stehen!\\
