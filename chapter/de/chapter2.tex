...
der Geräterückseite abgeschaltet wird.
...
vorher komplett heruntergefahren ist! Bei unkontrolliertem Ausschalten kann es 
ansonsten vorkommen, dass der Strom \textit{genau während eines Schreibzugriffes
auf die SD-Karte} weggenommen wird. Dieser dadurch möglicherweise unvollständige 
oder fehlerhafte Schreibzugriff kann das Dateisystem auf der SD-Karte auf 
undefinierte Weise beschädigen. Auch wenn dies zu 99\% der Fälle nicht eintritt, 
so sollte es dennoch vermieden werden, um einem Datenverlust auf der SD-Karte 
vorzubeugen! 
\end{bclogo}
